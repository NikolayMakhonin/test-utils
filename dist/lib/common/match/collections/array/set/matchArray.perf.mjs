...
import { matchArraySet } from './matchArraySet.mjs';
import { match, isMatcher, getKey } from '../../../test/helpers.mjs';
import { matchArrayMapOptimized } from './matchArrayMapOptimized.mjs';
import './matchArraySetOptimized.mjs';
...
describe('matchArray', function () {
    it('perf', function () {
        ...
        const result = calcPerformance(1000, () => {
        }, () => {
