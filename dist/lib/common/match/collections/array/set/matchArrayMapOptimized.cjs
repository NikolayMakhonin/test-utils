...
var common_match_contracts = require('../../../contracts.cjs');
...
function matchArrayMapOptimized(actual, expected, getKey, match, options) {
    ...
    if (!(options === null || options === void 0 ? void 0 : options.mayNotContains) && (actualMap === null || actualMap === void 0 ? void 0 : actualMap.size) && (expectedMap === null || expectedMap === void 0 ? void 0 : expectedMap.size)) {
        actualMap.forEach((actualValues, actualKey) => {
            if (actualKey === common_match_contracts.ANY) {
                for (const [expectedKey, expectedValues] of expectedMap) {
                    f1(common_match_contracts.ANY, expectedKey, actualValues, expectedValues);
                    if (actualValues.length === 0) {
                        break;
                    }
                }
                ...
                if (actualValues.length > 0) {
                    expectedValues = expectedMap.get(common_match_contracts.ANY);
                    f1(actualKey, common_match_contracts.ANY, actualValues, expectedValues);
                }
            }
        });
    }
    if (!(options === null || options === void 0 ? void 0 : options.mayNotContained) && (actualMap === null || actualMap === void 0 ? void 0 : actualMap.size) && (expectedMap === null || expectedMap === void 0 ? void 0 : expectedMap.size)) {
        expectedMap.forEach((expectedValues, expectedKey) => {
            if (expectedKey === common_match_contracts.ANY) {
                ...
                if (expectedValues.length > 0) {
                    actualValues = actualMap.get(common_match_contracts.ANY);
                    f1(common_match_contracts.ANY, expectedKey, actualValues, expectedValues);
                }
            }
        });
    ...
    if (actualMap === null || actualMap === void 0 ? void 0 : actualMap.size) {
        ...
        if (options === null || options === void 0 ? void 0 : options.actualRepeats) {
            if (!expectedFoundMap) {
                ...
                return {
                    ...
                    nested: [{
                            ...
                            expectedKey: common_match_contracts.UNSET,
                            result: common_match_match.createMatchResultSync(actualItem.value, common_match_contracts.UNSET, false),
                        }],
                };
            }
            for (const [actualKey, actualValues] of actualMap) {
                if (actualKey === common_match_contracts.ANY) {
                    ...
                    if (!found) {
                        return {
                            ...
                            nested: [{
                                    ...
                                    expectedKey: common_match_contracts.UNSET,
                                    result: common_match_match.createMatchResultSync(actualValues[0].value, common_match_contracts.UNSET, false),
                                }],
                        };
                    }
                }
                    ...
                    if (!found) {
                        expectedValues = expectedFoundMap === null || expectedFoundMap === void 0 ? void 0 : expectedFoundMap.get(common_match_contracts.ANY);
                        if (expectedValues && f2(actualMap, actualKey, actualValues, expectedValues, false)) {
                            found = true;
                        }
                    }
            ...
            return {
                ...
                nested: [{
                        actualKey: actualItem.index,
                        expectedKey: expectedItem ? expectedItem.value : common_match_contracts.UNSET,
                        result: common_match_match.createMatchResultSync(actualItem.value, expectedItem ? expectedItem.value : common_match_contracts.UNSET, expectedItem ? 'actual duplicate' : false),
                    }],
            };
        }
    }
        ...
        if (options === null || options === void 0 ? void 0 : options.expectedRepeats) {
            if (!actualFoundMap) {
                return {
                    result: false,
                    nested: [{
                            actualKey: common_match_contracts.UNSET,
                            expectedKey: expectedMap.entries().next().value[1][0].index,
                            result: common_match_match.createMatchResultSync(common_match_contracts.UNSET, expectedMap.entries().next().value[1][0].value, false),
                        }],
                };
            }
            for (const [expectedKey, expectedValues] of expectedMap) {
                if (expectedKey === common_match_contracts.ANY) {
                    ...
                    if (!found) {
                        return {
                            ...
                            nested: [{
                                    ...
                                    result: common_match_match.createMatchResultSync(common_match_contracts.UNSET, expectedValues[0].value, false),
                                }],
                        };
                    }
                }
                    ...
                    if (!found) {
                        actualValues = actualFoundMap === null || actualFoundMap === void 0 ? void 0 : actualFoundMap.get(common_match_contracts.ANY);
                        if (actualValues && f2(expectedMap, expectedKey, expectedValues, actualValues, true)) {
                            found = true;
                        }
                    }
            ...
            return {
                result: false,
                nested: [{
                        actualKey: actualItem ? actualItem.value : common_match_contracts.UNSET,
                        expectedKey: expectedItem.index,
                        result: common_match_match.createMatchResultSync(actualItem ? actualItem.value : common_match_contracts.UNSET, expectedItem.value, actualItem ? 'expected duplicate' : false),
                    }],
            };
        }
    }
...
exports.matchArrayMapOptimized = matchArrayMapOptimized;
